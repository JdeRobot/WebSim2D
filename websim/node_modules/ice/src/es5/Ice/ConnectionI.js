...
Ice._ModuleRegistry.require(module, ["../Ice/AsyncStatus", "../Ice/Stream", "../Ice/OutgoingAsync", "../Ice/Debug", "../Ice/ExUtil", "../Ice/HashMap", "../Ice/IncomingAsync", "../Ice/RetryException", "../Ice/Promise", "../Ice/Protocol", "../Ice/SocketOperation", "../Ice/Timer", "../Ice/TraceUtil", "../Ice/Version", "../Ice/Exception", "../Ice/LocalException", "../Ice/BatchRequestQueue"]);
    ...
    _createClass(ConnectionI, [{
        ...
        value: function start() {
            ...
            try {
                ...
                this._transceiver.setCallbacks(function () {
                    _this.message(SocketOperation.Write);
                }, // connected callback
                function () {
                    _this.message(SocketOperation.Read);
                }, // read callback
                function () {
                    _this.message(SocketOperation.Write);
                } // write callback
        ...
        value: function asyncRequestCanceled(outAsync, ex) {
            ...
            if (outAsync instanceof Ice.OutgoingAsync) {
                ...
                try {
                    for (var _iterator = this._asyncRequests[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
        ...
        value: function message(operation) {
            ...
            if (this._hasMoreData.value) {
                Timer.setImmediate(function () {
                    _this4.message(SocketOperation.Read);
        ...
        value: function finish() {
            ...
            try {
                for (var _iterator2 = this._asyncRequests.values()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
