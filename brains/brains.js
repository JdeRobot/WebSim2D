function Brains(){
  this.startStopCode = function(play, reservedVariables, mainInterval, codeContent) {
    var image = document.getElementById("runbtn").firstChild;

    if(!play){
      image.src = "../assets/resources/stop-icon.png";
      codeContent = this.cleanRedefinition(codeContent, reservedVariables);
      play = true;
  ...
  this.cleanRedefinition = function(scriptContent, reservedVariables){
    /*
